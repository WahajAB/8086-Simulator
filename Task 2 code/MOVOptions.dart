...
import './MOVREGTOREG.dart';
import 'package:adobe_xd/page_link.dart';
import './MOVMEMTOREG.dart';
import './MOVREGTOMEM.dart';
import './MOVIMMTOREG.dart';
import './HomeScreen.dart';
import 'package:flutter_svg/flutter_svg.dart';

class MOVOptions extends StatelessWidget {
  MOVOptions({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 109.0, end: 107.0),
            Pin(size: 208.0, middle: 0.4362),
            child: PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.SlideLeft,
